...
export class Report2Service {
  ...
  public getDistrict() : Observable<any> {
    ...
    public getselectedDivision(userPriv:any,disId:any) : Observable<any> {
      const url = "http://114.143.217.43:8080/";
      let queryParams = new HttpParams();
      // queryParams = queryParams.append('userPriv', userPriv);
      // queryParams = queryParams.append('disId', disId);
      return this.http.get(url + 'getDivisionsV1?userPriv='+userPriv+'&disId='+disId);
    ...
    const url = "http://114.143.217.43:8080/";
      ...
      return  this.http.get(url +  'getDivisionsV2?userPriv='+userPriv+'&disId='+disId+'&divId='+divId);
        ...
        public getselectedSubDivision(userPriv:any,disId:any,divId:any) : Observable<any> {
       const url ="http://114.143.217.43:8080/";
        let queryParams = new HttpParams();
        return this.http.get(url + 'getSubDivisionsV1?userPriv='+userPriv+'&disId='+disId+'&divId='+divId);
      }

     public getSubDivision( disData:any, divisionData:any,userPriv:any ) : Observable<any> {
      const url = "http://114.143.217.43:8080/";
      let queryParams = new HttpParams();
      queryParams =  queryParams.append('disId', disData);
    ...
    // return this.http.get(url + 'getSubDivisionsV2?userPriv='+userPriv+'&disId='+disId+'&divId='+divId);
    return this.http.get(url + 'getSubDivisionsV2?disId='+disData+'&divId='+divisionData+'&userPriv='+userPriv);

    }

    public getSubDivision1( userPriv:any,disId:any,divId:any, sudId:any) : Observable<any> {
      const url = "http://114.143.217.43:8080/";
      let queryParams = new HttpParams();
      // queryParams =  queryParams.append('disId', disData);
      // queryParams =  queryParams.append('divId', divisionData);
